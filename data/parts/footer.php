<footer>
    <div class="col-12 text-center mt-3">
        <ul class="list-unstyled m-0 pb-4">
            <li class="nav-item d-inline-flex m-0">
                <a class="nav-link icon-link px-2 fs-3" href="/x" target="_blank">
            ...
            <li class="nav-item d-inline-flex m-0">
                <a class="nav-link icon-link px-2 fs-3" href="/discord" target="_blank" style="color: #5663EA;">
            ...
            <li class="nav-item d-inline-flex m-0">
                <a class="nav-link icon-link px-2 fs-3" href="https://www.youtube.com/@TheGenieRats" target="_blank" style="color: #FF0000;">
            ...
            <li class="nav-item d-inline-flex m-0">
                <a class="nav-link icon-link px-2 fs-3" href="https://www.tiktok.com/@thegenierats" target="_blank">
